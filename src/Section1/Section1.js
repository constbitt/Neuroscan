      ...
      <div className="frame11">
        ...
        <div className="frame10">
          <div className="frame8">
            ...
            Компания Нейроскан понимает, насколько важны ваши любимцы. Наша цель - сделать диагностику заболеваний более точной и доступной,
предоставляя ветеринарным клиникам удобный и высококачественный
инструмент для анализа рентгеновских снимков.  
            </p>
            <div className="list">
 ...
 объединяя передовые технологии и опыт лучших ветеринарных специалистов, чтобы обеспечить здоровье и благополучие ваших питомцев.  
            </p>
            <button
              className={`btn3`}
              onClick={handleClick}
